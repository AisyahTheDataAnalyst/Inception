...
if [ ! -d "/var/lib/mysql/${MYSQL_DATABASE}" ]; then
    ...
    # 2.1 Create your application database and user first (while root has no password by default)
    ...
    # 2.2 Change the root password LAST so you don't lock yourself out of the session
